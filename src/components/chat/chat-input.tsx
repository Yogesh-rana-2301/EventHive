...
export function ChatInput() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const containsBannedWord = bannedWords.some(word => lowercaseMessage.includes(word))
    ...
    sendMessage(activeRoom.id, message.trim(), isAnonymous)
    ...
    <div className="border-t border-gray-200 bg-white">
      ...
      <form onSubmit={handleSubmit} className="p-4">
        ...
        <div className="text-xs text-gray-500 mt-2">
          ...
          <button className="text-primary-600 hover:underline">community guidelines</button>.
